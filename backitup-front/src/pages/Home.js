...
export default function Home({ setPageTitle, setUserType, isAuth }) {
  ...
  const loadPosts = async () => {
    const result1 = await axios.get("https://orbital-1690142964708.azurewebsites.net/api/listPosts/status/1") // change the link
    const result2 = await axios.get("https://orbital-1690142964708.azurewebsites.net/api/listPosts/status/2")
