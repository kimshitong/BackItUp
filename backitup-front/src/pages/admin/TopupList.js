...
export default function UsersList() {
    ...
    const loadUsers = async () => {
        const result = await axios.get("http://orbital-1687676297440.azurewebsites.net/api/listTopup")
        console.log(result);
    ...
    const clickVerify = (user) => {
        ...
        axios.get(`http://orbital-1687676297440.azurewebsites.net/api/topup/verify/${user.topupID}/${formattedDate}`)
        alert("Successfully verified! Please refresh the page.")
    }

    const clickUnverify = (userID) => {
        axios.get(`http://orbital-1687676297440.azurewebsites.net/${userID}/unverify`)
