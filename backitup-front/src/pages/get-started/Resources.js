    ...
    <div className='container mb-5'>
        ...
        <div className='col-md-6 px-5' style={{textAlign: "left"}}>
            ...
            <div className='col-md-6 px-5' style={{textAlign: "left"}}>
                ...
                <h3 class="display-10 fw-bold">Jacob's Picks</h3>
                <p>Man like Geoff.</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/gcevHkNGrWQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <hr />
                <p>One of the most important skills you must have.</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/17XZGUX_9iM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <hr />
                <p>A classic.</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/yQLhWtgAT0A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
