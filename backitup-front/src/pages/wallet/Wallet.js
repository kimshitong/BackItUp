...
export default function Wallet({currUser, isAuth}) {
   ...
   const loadWallet = async () => {
       const result = await axios.get(`https://orbital-1687703004396.azurewebsites.net/api/user/${currUser.userID}/wallet`) // change the link as necessary
       ...
       console.log("my wallet", wallet);
        const result2 = await axios.get(`https://orbital-1687703004396.azurewebsites.net/api/listTopUp/${id}`)
        setTopups(result2.data)

        const result3 = await axios.get(`https://orbital-1687703004396.azurewebsites.net/api/listWithdrawal/${id}`)
        setWds(result3.data)

        const result4 = await axios.get(`https://orbital-1687703004396.azurewebsites.net/api/listinvest/user/${currUser.userID}`)
        setWds(result4.data)
   }
